...
$launcherModulePath = Join-Path $PSScriptRoot 'MathResearchLauncherV2.psm1'
...
$projectModulePath = Join-Path $PSScriptRoot 'MathResearchProjectArchiveV2.psm1'
    ...
    try {
        ...
        switch ($Action) {
            ...
            'AttemptEnd' {
                ...
                if ([int]$state.Policy.schema_version -eq 3) {
                    if ([string]::IsNullOrWhiteSpace($AttemptRecordFile)) { throw 'Prompt v7 cycle-schema-3 AttemptEnd requires -AttemptRecordFile.' }
            ...
            'AuditEnd' {
                ...
                if (-not [string]::IsNullOrWhiteSpace($NextTicketsFile)) {
                    ...
                    if ([int]$state.Policy.schema_version -eq 3 -and [int]$nextRead.Value.schema_version -ne 3) { throw 'Prompt v7 audits must bind ticket manifest schema 3.' }
