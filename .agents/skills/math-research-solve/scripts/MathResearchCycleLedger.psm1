...
$launcherModulePath = Join-Path $PSScriptRoot 'MathResearchLauncher.psm1'
...
function Read-CycleJsonFile {
    ...
    try { $value = $info.Text | ConvertFrom-Json -AsHashtable -Depth 64 }
...
function Add-CycleEvent {
    ...
    $stablePayload = (ConvertTo-CanonicalJson -InputObject $payload) | ConvertFrom-Json -AsHashtable -Depth 64
